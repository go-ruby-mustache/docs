...
The public API lives at the module root (`github.com/go-ruby-mustache/mustache`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `mustache`, while the surface follows
...
```go
import "github.com/go-ruby-mustache/mustache"
```
...
- **[pkg.go.dev/github.com/go-ruby-mustache/mustache](https://pkg.go.dev/github.com/go-ruby-mustache/mustache)**

The module's [README](https://github.com/go-ruby-mustache/mustache#readme) carries worked
