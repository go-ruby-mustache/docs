# go-ruby-mustache documentation

**Pure-Go (CGO=0) MRI-faithful Ruby mustache**

`go-ruby-mustache/mustache` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `mustache`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `mustache`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`mustache`](https://github.com/go-ruby-mustache/mustache) | the library — Ruby's `mustache` in pure Go |
| [`docs`](https://github.com/go-ruby-mustache/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-mustache.github.io`](https://github.com/go-ruby-mustache/go-ruby-mustache.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-mustache/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-mustache/mustache](https://github.com/go-ruby-mustache/mustache).
