...
Contributions are welcome. `go-ruby-mustache/mustache` is built to a small set of
...
The library is in [`github.com/go-ruby-mustache/mustache`](https://github.com/go-ruby-mustache/mustache).
This documentation site is in [`github.com/go-ruby-mustache/docs`](https://github.com/go-ruby-mustache/docs).
